...
MODEL_TO_ROBOT_MAPPING = {
    ...
    'follow_left_arm_joint_pos':     {'name': 'follow1_joints', 'shape': 7, 'slice': slice(0, 7)},
    'follow_right_arm_joint_pos':    {'name': 'follow2_joints', 'shape': 7, 'slice': slice(0, 7)},
    'master_left_arm_joint_pos':     {'name': 'follow1_joints', 'shape': 7, 'slice': slice(0, 7)},
    'master_right_arm_joint_pos':    {'name': 'follow2_joints', 'shape': 7, 'slice': slice(0, 7)},
    'master_left_arm_delta_joint_pos':     {'name': 'follow1_joints', 'shape': 7, 'slice': slice(0, 7)},
    'master_right_arm_delta_joint_pos':    {'name': 'follow2_joints', 'shape': 7, 'slice': slice(0, 7)},
